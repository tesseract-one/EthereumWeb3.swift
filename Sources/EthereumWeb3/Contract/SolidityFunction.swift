...
public protocol SolidityFunctionHandler: class {
    ...
    func call(_ call: Call, outputs: [SolidityFunctionParameter], block: QuantityTag, completion: @escaping (Swift.Result<[String: Any], Error>) -> Void)
    func send(_ transaction: Transaction, completion: @escaping (Swift.Result<EthData, Error>) -> Void)
    func estimateGas(_ call: Call, completion: @escaping (Swift.Result<Quantity, Error>) -> Void)
}
...
public class SolidityConstructor {
    ...
    public func invoke(byteCode: EthData, parameters: [ABIEncodable]) -> SolidityConstructorInvocation {
